...
class PDFService:
    ...
    def __init__(self):
        ...
        if not os.path.exists(self.font_path_regular):
            raise FileNotFoundError("English font not found. Please download NotoSans-Regular.ttf")
    ...
    def _add_header(self, pdf: FPDF, paper: QuestionPaper):
        ...
        if paper.institution and paper.institution.name:
            ...
            pdf.cell(0, 10, paper.institution.name, align="C", new_x="LMARGIN", new_y="NEXT")
